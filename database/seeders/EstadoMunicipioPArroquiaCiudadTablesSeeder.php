...
class EstadoMunicipioPArroquiaCiudadTablesSeeder extends Seeder
{
    /**
    ...
    {
        //Estado
        DB::insert("INSERT INTO estados (`id`, `estado`, `iso_3166-2`) VALUES
			(1, 'Amazonas', 'VE-X'),
			(2, 'Anzoátegui', 'VE-B'),
			(3, 'Apure', 'VE-C'),
			(4, 'Aragua', 'VE-D'),
		...
		//municipio
        DB::insert("INSERT INTO municipios (id, id_estado, municipio) VALUES
			(1, 1, 'Alto Orinoco'),
			(2, 1, 'Atabapo'),
			(3, 1, 'Atures'),
			(4, 1, 'Autana'),
		...
		//parroqia
		DB::insert("INSERT INTO parroquias (id, id_municipio, parroquia) VALUES
			(1, 1, 'Alto Orinoco'),
		...
		//ciudad
		DB::insert("INSERT INTO ciudades (id, id_estado, ciudad, id_capital) VALUES
			(1, 1, 'Maroa', 0),
